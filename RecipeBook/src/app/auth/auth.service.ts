...
export class AuthService{
    ...
    signup(email: string, password: string){
        return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA1r4cIu3pipvN_S__MxdQuuM-py7Inho0',
    ...
    login(email: string, password: string){
        return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyA1r4cIu3pipvN_S__MxdQuuM-py7Inho0',
    ...
    private handleError(errorRes: HttpErrorResponse){
        let errorMessage='An error has occured!'
            ...
            switch(errorRes.error.error.message){
                ...
                case 'INVALID_PASSWORD' : errorMessage = 'The password is not correct'; break;
            }
            return throwError(errorMessage)
        }
